...
//			+ "	VALUES ( :full_name, :email,:address, :phone, :gender, :birth_date,  :password, :created_by);";
	...
	public List<Department> getAllDepartments() {
		RowMapper<Department> rowMapper = (rs, rowNum) -> {
			Department department = new Department(rs.getInt("department_id"), rs.getString("name"), rs.getString("description"));
		    return department;
		};
	...
	public boolean updateEmployee(Employee employee) {
		MapSqlParameterSource namedParameters = new MapSqlParameterSource();
			...
			namedParameters.addValue("departmentId", employee.getDepartment().getDepartmentId());
